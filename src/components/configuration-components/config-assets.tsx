import { add, iconHorizon, noAsset, plus, search } from "@/constants/assets";
  ...
  const allAssets = [
    {
      ...
      description: "An official document.",
    },
    {
      name: "Passport",
      description: "An official travel document.",
    },
  ];
      ...
      {allAssets.length > 0 ? (
        <div className="p-5 bg-white rounded-md drop-shadow-md">
          ...
          <div className="w-full mt-10 bg-white m-auto font-Inter border rounded-lg">
            <div className="py-3 px-2 flex items-center rounded-lg border-b">
              <span className="flex w-[45%] text-h12 font-bold">Assets</span>
              <span className="flex w-[45%] text-h12 font-bold">Description</span>
              ...
              {allAssets.map((asset, index) => (
                ...
                >
                  <div className="cursor-pointer flex items-center justify-between w-full relative animate-fadeDownFast">
                    <span className="block w-[45%] text-h12 text-[#272525] font-normal">
                      {asset.name}
                    </span>
                    <span className="block w-[45%] text-h12 text-gray-1 font-normal">
                      {asset.description}
                    </span>
        ...
        <div className="flex w-full h-[65vh] flex-col justify-center items-center my-5">
          ...
          >
            ...
            <span className="ml-3 font-medium font-Urbanist">Create Asset</span>
          </button>
        </div>
      )}
      {showForm && (
